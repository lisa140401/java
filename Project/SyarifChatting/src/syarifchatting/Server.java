...
public class Server extends javax.swing.JFrame implements Runnable{
    ...
    BufferedReader Server1_Reader, Client1_Reader;  
    BufferedWriter Server_Writer, Client_Writer;
    BufferedWriter Server1_Writer, Client1_Writer;
        public Server() {
    ...
    private void getComboBox(){
        ...
        if(ComboBox.getSelectedItem().equals("Server1")){
            ButtonOn.setText("On");
            Username.setText("Server1");
        }else{
            ButtonOn.setText("Connect");
            Username.setText("Client");
            Username.setText("Client2");
        }
    }
    }
    ...
    private void getClientConnec(){
        try {
            ...
            Server1_Reader = new BufferedReader(new InputStreamReader(client1.getInputStream()));
            Server1_Writer = new BufferedWriter (new OutputStreamWriter(client1.getOutputStream()));
    ...
    private void getReadConnec(){
        try {
            try {
                ...
                this.setTitle("Connected" + client1.getInetAddress());
            } catch (IOException ex) {
               System.out.println("Accept Failed");
               System.exit(-1);
            }
    ...
    private void getDisconnectedClient(){
        try {
            ...
            Server_Reader.close();
            Server_Writer.close();
            Server1_Reader.close();
            Server1_Writer.close();
    ...
    private void getSend(){
        try {
            ...
            Server_Writer.flush();
            Server1_Writer.write(Username.getText()+ ": " +TextChat.getText());
            Server1_Writer.newLine();
            Server1_Writer.flush();
        } catch (IOException ex) {
            Logger.getLogger(Form.class.getName()).log(Level.SEVERE, null, ex);
        }
 ...
 @Override
    public void run()
    {
        try {
            ...
            ListChat.add(Server1_Reader.readLine());
        } catch (IOException ex) {
            Logger.getLogger(Form.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
